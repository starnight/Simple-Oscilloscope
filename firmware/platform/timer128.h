...
#ifndef __AVR_ATMEGA128_TIMER_H__
#define __AVR_ATMEGA128_TIMER_H__
...
#define TIMER2_CLOCK_PRESCALER_D64		3
#define TIMER2_CLOCK_PRESCALER_D256		4
#define TIMER2_CLOCK_PRESCALER_D1024	5
